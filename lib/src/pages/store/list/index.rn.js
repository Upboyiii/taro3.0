...
const StoreList = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.SafeAreaView, Object.assign({ style: { flex: 1 } }, { children: [(0, jsx_runtime_1.jsx)(components_1.ScrollView, Object.assign({ scrollWithAnimation: true, style: { flex: 1, height: 100 }, scrollY: true, onScrollToLower: onScrollToLower }, { children: storeList.map((item, index) => {
                    var _a;
                ...
                }) })), (0, jsx_runtime_1.jsx)(components_1.View, Object.assign({ className: "bottom-bar" }, { children: (0, jsx_runtime_1.jsx)(button_1.default, Object.assign({ style: { width: "60%" }, size: "medium", type: "info", onClick: () => {
