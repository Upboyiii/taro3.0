...
const OwlButton = props => {
    ...
    const renderIcon = () => {
        ...
        if (props.loading) {
            ...
            return ((0, jsx_runtime_1.jsx)(react_native_1.ActivityIndicator, { color: color }));
        }
        if (props.icon) {
    ...
    return ((0, jsx_runtime_1.jsxs)(components_1.View, Object.assign({ className: classes, style: Object.assign(Object.assign({}, style), props.style), onClick: onClick }, { children: [renderBorder(), renderButton(), props.iconPosition === "left" && renderIcon(), renderText(), props.iconPosition === "right" && renderIcon()] })));
};
