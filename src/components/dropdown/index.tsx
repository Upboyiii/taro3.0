          ...
          <React.Fragment>
            {React.Children.toArray(props.children).map((child, index) => {
              ...
              return (
                ...
                >
                  <Text className={classnames(bem("menu-title", { disabled, active: itemShow[index] }))}>{finallyTitle()}</Text>
              ...
              return (
                <React.Fragment key={`dropdown-item-${index}`}>
                  ...
                  >
                    ...
                    >
                      <Text className={classnames( bem("tag-text",{ active: _value === item[props.format?.value ?? "value"] }))}>
            ...
            {props.options.map((item, index)=>{
              return (
                <React.Fragment key={`dropdown-aside-${index}`}>
                  ...
                  >
                    <Text className={classnames(bem("aside-text",{ active: _active === item[props.format?.value ?? "value"] }))}>
                      {item[props.format?.label ?? "label"]}
                    </Text>
                  </View>
                </React.Fragment>
