    ...
    setTableList(val=>{
      ...
      if(data){
        ...
        switch (msg.type) {
          ...
          case 5: {
            // 清桌
            let desks = { name: obj.name, desk_id: obj.desk_id };
            list[i].children[a] = desks;
            break;
          }
          case 6: // 取消菜品
            obj.total_amount = msg.total_amount;
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                ...
                                {/* <Text className={classnames(bem("desk-badge"))}>桌号</Text>*/}
                              </View>
                                ...
                                <View className={classnames(bem("state"))}>
                                  {!!item.order ? (
                                    <React.Fragment>
                                      <Tag
                                        size="small"
                                        type={item.state === 11 ? "warning" : item.state === 22 ? "primary" : "info"}
                                      >
                                        {states[item.state]}
                                      </Tag>
